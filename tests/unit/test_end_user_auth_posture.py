...
read
    ...
    bind_profile == local AND profile chosen AND CAPA_S2S_TOKEN unset
...
from issue_remediation_capa.adapters.gcp.identity import (
    IapIdentityAdapter,
)
from issue_remediation_capa.adapters.local.identity import (
    LocalIdentityAdapter,
)
from issue_remediation_capa.adapters.onprem.identity import (
...
from issue_remediation_capa.ports.identity import (
    CLIENT_ASSERTED,
    END_USER_AUTH_ATTR,
    END_USER_AUTH_KINDS,
    UNIMPLEMENTED,
