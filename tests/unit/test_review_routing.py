...
from issue_remediation_capa.adapters.gcp.review_router import (
    CloudReviewRouter,
)
from issue_remediation_capa.adapters.local.review_router import (
    LocalReviewRouter,
)
from issue_remediation_capa.adapters.onprem.review_router import (
    OnPremReviewRouter,
)
