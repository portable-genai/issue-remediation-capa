...
``CAPA_S2S_TOKEN`` used to switch the guard off under a DELIBERATE
...
from issue_remediation_capa.api.app import (
    app,
)
...
_IAP_AUDIENCE_ENV = "CAPA_IAP_AUDIENCE"
...
_API_MODULE = "issue_remediation_capa.api.app"
