...
from issue_remediation_capa.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("issue_remediation_capa.adapters.gcp.identity")
