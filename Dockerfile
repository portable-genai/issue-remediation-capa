# Issue Remediation and CAPA Tracker (issue-remediation-capa) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CAPA_PROFILE=gcp \
    CAPA_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn issue_remediation_capa.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
