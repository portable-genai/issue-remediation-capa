...
class AgentCard:
    ...
    provider: str = "issue-remediation-capa"
...
_DESCRIPTION = " ".join(
    (
        "Issue Remediation and CAPA Tracker",
        "(Aud3).",
...
def _resolve_url(settings: Settings) -> str:
    ...
    return f"https://issue-remediation-capa.{settings.region}.internal.example/a2a"
